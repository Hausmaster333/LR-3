...
gui: src/gui_main.cpp $(IMGUI_SRC) $(IMPLOT_SRC) src/solver.cpp
	$(CC) $(CFLAGS) $(GUI_FLAGS) src/gui_main.cpp src/bit_sequence.cpp src/sorting_station.cpp src/solver.cpp $(IMGUI_SRC) $(IMPLOT_SRC) $(GUI_LIBS) -o gui
...
deq_tests: tests/deque_tests.cpp $(GTEST_DIR)/src/gtest-all.cc $(GTEST_DIR)/src/gtest_main.cc src/sorting_station.cpp src/solver.cpp
	$(CC) $(CFLAGS) $(GTEST_FLAGS) tests/deque_tests.cpp $(GTEST_DIR)/src/gtest-all.cc $(GTEST_DIR)/src/gtest_main.cc src/sorting_station.cpp src/solver.cpp -o deq_tests
